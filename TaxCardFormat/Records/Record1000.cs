...
public class Record1000: TaxRecord
{
    ...
    [FieldFixedLength(8)] public required string Indberetter_SE_nummer;
    ...
    public Guid HovedindberetingsID;

    [FieldFixedLength(3)] 
    private string eIndkomst_version = "2.0";

    [FieldFixedLength(1)] public required char IsTest;
    
    [FieldFixedLength(32)] 
    private string filler2 = "";

    [FieldFixedLength(1)] public required char EIndkomst_Letløn;
}